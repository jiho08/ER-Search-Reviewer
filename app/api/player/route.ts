import { nicknameSchema, seasonIdSchema, sourceSchema } from "@/lib/server/validation";
...
export async function GET(request: Request) {
  ...
  if (season && !season.success)
    return Response.json({ error: "올바른 시즌을 선택해 주세요." }, { status: 400 });
